...
public enum eConflictChecker {
    ...
    CONFLICT_9(false,false,true,false,false,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_10(false,false,true,false,false,true) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_11(false,false,true,false,true,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_12(false,false,true,false,true,true) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    ...
    CONFLICT_14(false,false,true,true,false,true) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_15(false,false,true,true,true,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_16(false,false,true,true,true,true) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 2; }  @Override public boolean notTake() { return false; } },
    CONFLICT_17(false,true,false,false,false,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 1; }  @Override public boolean notTake() { return false; } },
    ...
    CONFLICT_21(false,true,false,true,false,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 1; }  @Override public boolean notTake() { return false; } },
    ...
    CONFLICT_23(false,true,false,true,true,false) { @Override public boolean isConflict() { return true; } @Override public boolean take() { return true; } @Override public int whatToTake() { return 1; }  @Override public boolean notTake() { return false; } },
