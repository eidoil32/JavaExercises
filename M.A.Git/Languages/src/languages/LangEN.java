...
public class LangEN {
    public static final String
            ...
            NONE_XML_FILE_EXTINCTION = "XML error 3.1: None xml file selected",
            ...
            DUPLICATE_ID_NUMBER = "XML error 3.2: Duplicate id of type '%s'",
            TOO_MANY_PREV_COMMITS = "XML error 3.15: One of commits has too many preceding commits (%s)",
            COMMIT_POINT_NONE_EXIST = "XML error 3.16: Commit point on none exist commit id - %s",
            ...
            COMMIT_POINT_TO_NONE_ROOT_FOLDER = "XML error 3.7: Commit point on none root folder",
            ENTER_XML_PATH = "Please enter path to magit xml file: ",
            XML_FILE_NOT_FOUND = "The XML file '%s' not found!",
            BRANCH_POINT_TO_NONSEXIST_COMMIT = "XML error 3.8: Branch point to none exist commit id %s",
            HEAD_POINT_TO_NONSEXIST_BRANCH = "XML error 3.9: Head point on none exist branch.",
            ...
            PLEASE_ENTER_TARGET_XML_PATH = "Please enter path to directory you want to export your repository (without '\\' or file name): "
            ...
            XML_DELETE_AND_START_NEW_REPOSITORY = "It's seems that there is already magit repository in path from XML," + System.lineSeparator()
                    + "Do you want to delete old magit folder? (type 'y' or 'yes') ",
