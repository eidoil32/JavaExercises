...
public enum eMenuItem {
    ...
    CREATE_NEW_REPO {
        @Override
        public String executeCommand() throws IOException, RepositoryException, MyFileException {
            Magit magit = Main.engine.getSystem();
...
//                    }
    ...
    public abstract String executeCommand() throws RepositoryException, IOException, MyFileException;
